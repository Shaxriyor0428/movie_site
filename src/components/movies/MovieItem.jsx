...
const MovieItem = ({ title, poster_path, vote_average, id }) => {
  ...
  return (
    <div className="rounded-lg overflow-hidden shadow-lg dark:bg-gray-800 p-4 flex flex-col items-center ">
      <img
      ...
      />
      <h2 className="font-medium text-[20px] text-black text-center mb-2 line-clamp-1 ">
        {title}
      </h2>
